...
const MI_HEADERS = Object.freeze({
  ...
  'Eventi': ['id_evento', 'id_gruppo', 'titolo', 'stato', 'capienza', 'apertura_iscrizioni', 'chiusura_iscrizioni', 'modalita_prezzo', 'data_aggiornamento', 'servizi_json', 'domande_json', 'profilo_operativo'],
