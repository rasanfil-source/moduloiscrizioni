const MI_STANDALONE_MODE = true;
// Rilascio Workspace 3.26.149
...
function decodificaProiezioneDiretta_(payload) {
  ...
  try {
    ...
    json=Utilities.ungzip(Utilities.newBlob(bytes)).getDataAsString('UTF-8');
