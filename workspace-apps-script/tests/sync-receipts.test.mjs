...
test('replica successiva riconosce una modifica accettata anche se quella intermedia è stata accorpata',()=>{
 const e=environment();
 e.c.confermaModificheFoglio_({event_id:'42',confirmations:[{...receipt,workspace_revision:'8'}]});
...
test('una replica obsoleta o incompleta non conferma la ricevuta',()=>{
 for(const revision of ['7',null,undefined]){
  const e=environment();e.c.confermaModificheFoglio_({event_id:'42',confirmations:[{...receipt,workspace_revision:'8'}]});
