...
Stato: implementazione revisionata — WordPress 3.19.1 / Workspace 1.8.0
Data: 27 agosto 2026
...
- Alla pubblicazione, ogni evento deve avere un solo gestore responsabile con email valida. Il foglio dedicato resta di proprietà dell’account Workspace ed è privato: eventuali condivisioni precedenti vengono revocate e l’unico altro accesso è concesso all’email del gestore. Il gestore riceve una comunicazione con pulsante verso l’evento, indirizzo visibile e copiabile e collegamento al foglio; l’invio rispetta sempre la modalità email generale e in `ANTEPRIMA` viene soltanto accodato come anteprima.
