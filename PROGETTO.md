...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.4.0 installata, attiva e verificata sul sito; la 0.4.1 è pronta per il collaudo. Il nuovo incremento mostra soltanto i campi economici pertinenti e mantiene in bozza gli eventi con prezzo, fonti o caparra incoerenti. I quattro casi restano sola iscrizione, prezzo informativo, versamento completo oppure caparra e saldo. Non contiene coordinate operative e non riscuote pagamenti. La coda email resta `PREVIEW`. Le funzionalità live comprendono salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento, esportazione CSV ed editor sintetico. Pagamenti e invii reali non sono operativi.
