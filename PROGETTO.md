...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.4.4 installata, attiva e verificata sul sito; la 0.4.5 è pronta per il collaudo. Il nuovo incremento mostra nel riepilogo pubblico le fonti ammesse con etichette italiane e chiarisce che i versamenti vengono registrati manualmente dall’organizzazione. Non contiene coordinate operative e non riscuote pagamenti. La coda email resta `PREVIEW`. Le funzionalità live comprendono salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento, esportazione CSV ed editor sintetico. Pagamenti e invii reali non sono operativi.
