...
Stato: implementazione revisionata — WordPress 3.20.2 / Workspace 1.8.0
Data: 27 agosto 2026
...
- Il gestore è facoltativo: la sua assenza non impedisce la pubblicazione o la creazione del foglio. Senza un responsabile univoco con email valida non si aggiungono condivisioni né si prepara una notifica al gestore; gli accessi Google esistenti restano invariati. I ruoli WordPress non concedono automaticamente permessi Google Drive. Quando il gestore è individuato, la comunicazione dedicata rispetta la modalità email generale e in `ANTEPRIMA` viene soltanto accodata come anteprima.
