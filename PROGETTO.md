...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.3.2 pronta per il collaudo sul sito. La versione estende l'outbox storica conservando, oltre al modello già risolto e all'impronta della revisione, il nome dell'attività, il logo e il relativo testo alternativo. Il pannello può così mostrare l'identità valida al momento dell'iscrizione senza ricalcolarla dopo modifiche successive. Non esiste alcuna funzione di spedizione e la coda resta `PREVIEW`. I tentativi di verifica della 0.3.1 sul sito non sono stati conclusivi perché WordPress ha superato ripetutamente i tempi di risposta anche sulla pagina dei plugin; non viene quindi registrato uno stato live non verificato. Le funzionalità live già collaudate fino alla 0.3.0 restano salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento, esportazione CSV ed editor sintetico. Pagamenti e invii reali non sono operativi.
...
- editor e anteprima email: editor per evento completato nella 0.3.0 con segnaposto italiani, HTML limitato, testo semplice e dati sintetici; istantanea risolta e impronta della revisione nell'outbox completate nella 0.3.1; identità storica dell'attività completata nella 0.3.2; prova controllata resta un incremento successivo;
