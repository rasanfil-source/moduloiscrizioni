...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.3.0 installata, attiva e collaudata sul sito. La versione aggiunge per ogni evento un editor dell'email di conferma con oggetto, preheader, corpo HTML limitato, testo semplice, footer, segnaposto italiani controllati e anteprima basata esclusivamente su dati sintetici. Non esiste alcuna funzione di spedizione e la coda resta `PREVIEW`. Le funzionalità già collaudate comprendono salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento ed esportazione CSV limitata alle attività accessibili. L'evento 2027 risulta pubblicato nel tipo di contenuto amministrativo non pubblico; la pagina pubblica di riferimento non contiene lo shortcode né gli asset del modulo e il collaudo non ha modificato stato o configurazione dell'evento. Pagamenti e invii reali non sono operativi.
...
- editor e anteprima email: primo editor per evento completato nella 0.3.0 con segnaposto italiani, HTML limitato, testo semplice e dati sintetici; versionamento completo, branding ereditato e prova controllata restano incrementi successivi;
