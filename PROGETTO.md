...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.4.2 installata, attiva e verificata sul sito; la 0.4.3 è pronta per il collaudo. Il nuovo incremento rende totale, primo versamento e saldo visibili nell’elenco e nel dettaglio delle iscrizioni e li include nell’esportazione CSV con intestazioni italiane. Non contiene coordinate operative e non riscuote pagamenti. La coda email resta `PREVIEW`. Le funzionalità live comprendono salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento, esportazione CSV ed editor sintetico. Pagamenti e invii reali non sono operativi.
