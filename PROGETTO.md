...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.5.0 installata, attiva e verificata sul sito. Il completamento coordinato Workspace resta in attesa dell’aggiornamento del progetto Apps Script e dell’esecuzione di “Inizializza/aggiorna struttura”: aggiungerà in coda alla scheda `Iscrizioni` modalità economica, primo versamento, saldo e fonti ammesse senza spostare le righe esistenti. Non contiene coordinate operative e non riscuote pagamenti. La coda email resta `PREVIEW`. Pagamenti e invii reali non sono operativi.
