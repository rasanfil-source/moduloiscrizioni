...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.4.3 installata, attiva e verificata sul sito; la 0.4.4 è pronta per il collaudo. Il nuovo incremento mostra nel modulo pubblico il totale e, quando applicabili, caparra e saldo calcolati in tempo reale; la conferma riepiloga il primo versamento previsto soltanto per le iscrizioni confermate. Non contiene coordinate operative e non riscuote pagamenti. La coda email resta `PREVIEW`. Le funzionalità live comprendono salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento, esportazione CSV ed editor sintetico. Pagamenti e invii reali non sono operativi.
