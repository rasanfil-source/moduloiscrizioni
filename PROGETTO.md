...
Esito Fase A: completata. Fase 2: vertical slice WordPress 0.3.4 installata, attiva e verificata sul sito; la 0.4.0 è pronta per il collaudo. Il nuovo incremento configura per evento sola iscrizione, prezzo informativo, versamento completo oppure caparra e saldo, con percentuale della caparra e fonti ammesse tra bonifico, carta e contante. Non contiene coordinate operative e non riscuote pagamenti. La coda email resta `PREVIEW`. Le funzionalità live comprendono salvataggio locale autorevole, replica Workspace idempotente, capienza, profili dati, dettaglio partecipanti, ricerca, filtro evento, esportazione CSV ed editor sintetico. Pagamenti e invii reali non sono operativi.
