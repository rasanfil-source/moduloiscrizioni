...
require_once MI_PLUGIN_DIR . 'includes/class-mi-extra-services.php';
...
require_once MI_PLUGIN_DIR . 'includes/class-mi-booking-update-email.php';
...
require_once MI_PLUGIN_DIR . 'includes/class-mi-event-projection.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-event-read-cache.php';
...
require_once MI_PLUGIN_DIR . 'includes/class-mi-portal-payments.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-payment-ledger.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-portal.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-public-balance.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-event-duplicator.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-event-deletion.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-portal-management.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-sheet-open.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-management-service.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-management-list.php';
require_once MI_PLUGIN_DIR . 'includes/class-mi-attendance-report.php';
...
add_action( 'template_redirect', array( 'MI_Public_Balance', 'route' ), -110 );
