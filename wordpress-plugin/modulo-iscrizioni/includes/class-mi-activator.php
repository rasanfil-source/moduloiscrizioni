...
final class MI_Activator {
	...
	private static function create_tables() {
		...
		dbDelta( "CREATE TABLE {$registrations} (
			...
			workspace_next_attempt_at datetime NULL,
			...
			KEY workspace_queue (workspace_status,workspace_next_attempt_at,workspace_attempts,id),
		...
		dbDelta( "CREATE TABLE {$participants} (
			...
			deposit_due_cents bigint(20) unsigned NULL,
		...
		dbDelta( "CREATE TABLE {$payments} (
			...
			participant_allocations_json longtext NULL,
