...
final class MI_Portal {
	...
	public static function handle_actions() {
		...
		$service_labels = array( 'colazione' => 'Colazione', 'pranzo' => 'Pranzo', 'rimborso-spese' => 'Rimborso spese' );
		...
		foreach ( $service_labels as $service_code => $service_label ) {
			...
			$service_options[] = array( 'code' => $service_code, 'name' => $service_label, 'scope' => 'TICKET', 'price_cents' => $service_price, 'max_quantity' => 1, 'category' => in_array( $service_code, array( 'colazione', 'pranzo' ), true ) ? 'pranzo' : 'altro' );
		}
