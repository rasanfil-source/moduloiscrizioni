	...
	public static function page() {
		...
		<div class="wrap">
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<tr><th scope="row"><label for="mi_email_segreteria_eventi">Email segreteria eventi</label></th><td><input class="regular-text" type="email" id="mi_email_segreteria_eventi" name="mi_email_segreteria_eventi" value="<?php echo esc_attr( get_option( 'mi_email_segreteria_eventi', 'info@parrocchiasanteugenio.it' ) ); ?>"><p class="description">Riceve sempre la comunicazione di attivazione dell’evento. Se è assegnato un operatore, la riceve anche lui. Non modifica il mittente del sito né i permessi Google.</p></td></tr>
				</tbody></table>
