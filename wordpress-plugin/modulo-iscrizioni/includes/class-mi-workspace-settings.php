...
final class MI_Workspace_Settings {
	...
	public static function page() {
		...
		<div class="wrap">
			...
			<?php if ( 'schema_ok' === $notice ) : ?><div class="notice notice-success"><p>Schema Workspace 1.5.0 verificato: schede prenotazione, stati individuali, viste operative e colonne economiche sono disponibili.</p></div><?php endif; ?>
	...
	public static function test_schema() {
		...
		$valid = ! is_wp_error( $result ) && '1.5.0' === ( $result['schema_version'] ?? '' ) && ! array_diff( $required, $headers );
