	...
	public static function render( $attributes ) {
		...
		<section id="<?php echo esc_attr( $instance_id ); ?>" class="mi-registration" style="--mi-primary:<?php echo esc_attr( $event['accent_color'] ); ?>;--mi-primary-dark:<?php echo esc_attr( self::darken_color( $event['accent_color'] ) ); ?>" data-mi-config="<?php echo esc_attr( wp_json_encode( $config ) ); ?>">
			...
			<form class="mi-registration__form" novalidate>
				...
				<section class="mi-registration__step" data-mi-step="2" aria-labelledby="<?php echo esc_attr( $instance_id ); ?>-step-2" hidden><h2 id="<?php echo esc_attr( $instance_id ); ?>-step-2" tabindex="-1">Informazioni di contatto</h2><div class="mi-registration__grid mi-registration__contact"><label>Nome *<input name="buyerFirstName" maxlength="80" autocomplete="given-name" required></label><label>Cognome *<input name="buyerLastName" maxlength="80" autocomplete="family-name" required></label><label>Indirizzo email <input name="buyerEmail" type="email" maxlength="254" autocomplete="email"></label><label>Telefono cellulare *<input name="buyerPhone" type="tel" maxlength="32" autocomplete="tel" placeholder="+39 …" required><small class="mi-registration__field-help">Inserire il prefisso internazionale, per esempio +39.</small></label></div><h3 data-mi-participants-heading>Prenotazione</h3><div class="mi-registration__participants" data-mi-participants></div></section>
