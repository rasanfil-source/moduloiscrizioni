...
assert.match(model, /width:48px;height:48px;padding:2px;[^>]*border-radius:50%;background:#ffffff/);
assert.match(model, /width="44" height="44"[^>]*border-radius:50%;object-fit:cover/);
