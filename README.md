...
La versione WordPress `0.5.1` e Apps Script `1.1.0` sono installate e collegate. Il controllo firmato non invasivo dello schema Workspace è stato collaudato con esito positivo: versione `1.1.0` e intestazioni economiche italiane risultano disponibili, senza creare iscrizioni. Il deployment resta in modalità `ANTEPRIMA`; non vengono memorizzati IBAN o collegamenti carta, non esiste alcuna riscossione e la coda email resta `PREVIEW`.
