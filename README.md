...
La versione `0.4.4` è installata, attiva e verificata sul sito. La `0.4.5` è pronta per il collaudo: il riepilogo pubblico mostra in italiano le fonti ammesse tra bonifico, carta e contante e chiarisce che i versamenti vengono registrati manualmente dall’organizzazione. La lista d’attesa non mostra richieste di versamento. Non vengono memorizzati IBAN o collegamenti carta, non esiste alcuna riscossione e la coda email resta `PREVIEW`.
