...
Il codice locale contiene la versione **3.26.132**. La versione installata sul sito richiede una verifica separata. Il [manuale del segretario](docs/manuale-segretario/Manuale_del_segretario.docx) descrive criteri e procedure operative. Le modifiche dell’ultimo rilascio sono descritte nelle [profili coerenti, regole condivise e apertura verificata](docs/rilascio-3.26.132.md).
