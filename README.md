...
La versione `0.3.0` è installata, attiva e collaudata sul sito. Aggiunge per ogni evento un editor dell'email di conferma con oggetto, preheader, corpo HTML limitato, testo semplice, footer, segnaposto italiani controllati e anteprima basata esclusivamente su dati sintetici. Non esiste alcuna funzione di spedizione e la coda resta `PREVIEW`. Restano disponibili dettaglio partecipanti, ricerca, filtro evento ed esportazione CSV protetta e limitata alle attività accessibili. L'evento 2027 risulta pubblicato nel tipo di contenuto amministrativo non pubblico, ma la pagina pubblica di riferimento non contiene lo shortcode né gli asset del modulo; il collaudo non ne ha modificato lo stato o la configurazione. Pagamenti e invii reali restano non operativi.
