...
La versione `0.3.2` è pronta per il collaudo sul sito. Estende l'outbox storica conservando, oltre al modello già risolto e all'impronta della revisione, il nome dell'attività, il logo e il relativo testo alternativo. Il pannello può così mostrare l'identità valida al momento dell'iscrizione senza ricalcolarla dopo modifiche successive. Non esiste alcuna funzione di spedizione e la coda resta `PREVIEW`. I tentativi di verifica della 0.3.1 sul sito non sono stati conclusivi perché WordPress ha superato ripetutamente i tempi di risposta anche sulla pagina dei plugin; la documentazione non attribuisce quindi alla versione uno stato live non verificato. Pagamenti e invii reali restano non operativi.
