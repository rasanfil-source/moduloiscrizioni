...
La versione `0.4.2` è installata, attiva e verificata sul sito. La `0.4.3` è pronta per il collaudo: totale, primo versamento e saldo diventano visibili nell’elenco e nel dettaglio delle iscrizioni e vengono inclusi nell’esportazione CSV con intestazioni italiane. Non vengono memorizzati IBAN o collegamenti carta, non esiste alcuna riscossione e la coda email resta `PREVIEW`.
