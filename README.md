...
La versione `0.4.1` è installata, attiva e verificata sul sito. La `0.4.2` è pronta per il collaudo: ogni nuova iscrizione conserva il totale e, secondo la modalità economica, il primo versamento e il saldo successivo. Per la lista d’attesa il primo versamento è sempre zero. Il riepilogo storico è consultabile nell’anteprima amministrativa. Non vengono memorizzati IBAN o collegamenti carta, non esiste alcuna riscossione e la coda email resta `PREVIEW`.
