...
La versione `0.3.1` è pronta per il collaudo sul sito. Estende l'editor 0.3.0 conservando in ogni nuova voce locale dell'outbox una copia già risolta del modello e l'impronta della revisione; il pannello può mostrare HTML, testo semplice e metadati storici senza ricalcolarli dopo modifiche successive all'evento. Non esiste alcuna funzione di spedizione e la coda resta `PREVIEW`. Restano disponibili dettaglio partecipanti, ricerca, filtro evento ed esportazione CSV protetta e limitata alle attività accessibili. L'evento 2027 risulta pubblicato nel tipo di contenuto amministrativo non pubblico, ma la pagina pubblica di riferimento non contiene lo shortcode né gli asset del modulo. Pagamenti e invii reali restano non operativi.
