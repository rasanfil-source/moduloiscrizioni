...
Il repository contiene **3.26.82**. Durante la creazione di un evento, il modello può essere scelto fra tutti gli eventi in corso e fino a 10 eventi passati recenti. L’installazione WordPress resta separata dalla pubblicazione GitHub: [stato e istruzioni](docs/rilascio-3.26.82.md).
...
- [Rilascio corrente](docs/rilascio-3.26.82.md)
