...
La versione `0.4.3` è installata, attiva e verificata sul sito. La `0.4.4` è pronta per il collaudo: il modulo pubblico calcola e mostra in tempo reale totale, eventuale caparra e saldo; dopo l’iscrizione confermata riepiloga il primo versamento previsto. La lista d’attesa non mostra richieste di versamento. Non vengono memorizzati IBAN o collegamenti carta, non esiste alcuna riscossione e la coda email resta `PREVIEW`.
