...
La versione `0.2.9` è installata, attiva e collaudata sul sito. Sono stati verificati homepage, pagina Santiago, pannello eventi, migrazione compatibile, preset Minimo/Standard/Viaggio, anteprima amministrativa, caricamento condizionale degli asset e collegamento firmato a Workspace. Le iscrizioni vengono prima conservate localmente e poi replicate con idempotenza; gli errori temporanei restano `PENDING` e sono ritentati a piccoli lotti. Il pannello mostra il dettaglio dei partecipanti e i dati aggiuntivi con etichette leggibili, consente ricerca e filtro evento e prepara un CSV coerente con i filtri e con le attività accessibili; le date di nascita future o anteriori a 120 anni vengono rifiutate. Nel collaudo live sono stati verificati i controlli, una ricerca senza risultati e il collegamento firmato dell'esportazione, senza scaricare dati reali. La bozza 2027 conserva il profilo Minimo; attività ed evento non sono pubblicati. Email e pagamenti restano non operativi.
