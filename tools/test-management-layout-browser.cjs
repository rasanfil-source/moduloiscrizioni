...
assert.equal(await page.locator('[data-annual-group]').inputValue(),'5');
assert.equal(await page.locator('[data-annual-group] option').count(),1);
await page.unroute('**/ajax');await page.reload();await page.locator('[data-more]').waitFor();
assert.equal(await page.locator('[data-annual-report]').isVisible(),false);
