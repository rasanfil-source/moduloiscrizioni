...
$destination = Join-Path (Resolve-Path 'dist').Path 'modulo-iscrizioni-3.26.128.zip'
...
[IO.File]::WriteAllText($destination + '.sha256', "$hash  modulo-iscrizioni-3.26.128.zip`n")
